...
\includemedia[
    activate=onclick,
    width=0.6\textwidth
]{\includegraphics{../greenbunny}}{lambert_phong_blinn.swf}
\end{center}
...
\includemedia[
    activate=onclick,
    width=0.6\textwidth
]{\includegraphics{../greenbunny}}{cooktorrance.swf}
\end{center}
...
\includemedia[
    activate=onclick,
    width=0.6\textwidth
]{\includegraphics{../greenbunny}}{ward.swf}
\end{center}
...
\includemedia[
    activate=onclick,
    width=0.6\textwidth
]{\includegraphics{../greenbunny}}{ashikhmin.swf}
\end{center}
...
\includemedia[
    activate=onclick,
    width=0.6\textwidth
]{\includegraphics{../greenbunny}}{glass.swf}
\end{center}
...
\includemedia[
    activate=onclick,
    width=0.6\textwidth
]{\includegraphics{../greenbunny}}{mesh.swf}
\end{center}
