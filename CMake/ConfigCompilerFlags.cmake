...
# New VCA code requires C++11, need to signal gcc about it
...
if(OPTIX_USE_AGGRESSIVE_WARNINGS)
  ...
  # These flags are related to C++11 compatibility. All fixed, so it is empty. Left as placeholder.
  SET(c11_warnings "${c11_gnu_warnings} ${c11_clang_warnings}")
  SET(CXX_WARNING_FLAGS "-Wall -Werror -Wsign-compare -Wno-multichar ${clang_warnings} ${c11_warnings}")
